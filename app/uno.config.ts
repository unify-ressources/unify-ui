...
export default defineConfig({
  ...
  shortcuts: [
    {
      'blured-bg-ui': 'flex absolute inset-0 bg-bg !bg-op70 backdrop-blur-sm py',
      'btn-nav-icon': 'flex p1.5 items-center hover-bg-bg-light rd-lg text-xl duration-200 ease-linear',
      ...
      'btn-palette': 'wfull flex flex-col items-center text-center gap-1 ring-2 ring-transparent ring-offset-2 ring-offset-white dark-ring-offset-gray-950 focus-visible-ring-[--palette-main-color] b b-transparent aria-checked-b-primary600 aria-checked-bg-bg-light aria-checked-!bg-op50 rd-md outline-0 focus-outline-0 [&[aria-checked=true]>[data-text]]-text-primary600 dark-[&[aria-checked=true]>[data-text]]-text-primary400',
      'palette-token': 'bg-[var(--palette-token)] wfull hfull flex',
      'btn-input-search': 'h9 b b-border-high rd-lg pl3 pr1.5 w50 hidden md-flex items-center justify-between gap-x2 text-sm hover-b-border-high hover-!b-op30 hover-bg-bg-light hover-!bg-op40',
      ...
      'btn-show-table-content': 'b b-border rd-lg py1.5 px2 flex items-center gap-x1 rd-lg text-sm hover-bg-bg-light ease-linear [&[aria-expanded=true]>span]:rotate-180',
      ...
      'tab-content-ui-bg': 'b b-border b-op90 dark-b-op60 bg-bg-light !bg-op70 backdrop-blur-xl !lg-bg-transparent !lg-b-transparent',
      'mdx-tbody': '[&>tr>td]-px2.5 [&>tr>td]-py1.5 divide-y divide-gray200 dark-divide-gray800 [&>tr]-!b-dashed',
      'mdx-thead': 'relative text-sm before-absolute before-inset-0 before-content-empty before-bg-bg-light-gray before-!bg-op60 before-rd-t-md text-left [&>tr]-relative [&>tr>th]-px2.5 [&>tr>th]-py3 text-fg-subtitle [&>tr>th]-font-medium',
