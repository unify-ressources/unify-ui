...
<div role="list" id="dropdown-1" data-drop-down class="ui-popper z-20 op0 invisible translate-y-3 fx-open-op100 fx-open-visible fx-open-translate-y-0 w-48 text-sm p-2 bg-bg-lighter b b-border/50 rd-lg flex flex-col overflow-hidden text-fg ease-linear transition-transform">
    <a href="#link" aria-label="some alt text for link"
        class="focus-outline focus-outline-primary focus-bg-bg-high outline-none ease-linear flex items-center gap-x-3 duration-200 hover-bg-bg-high p-2 rd-md">
